...
# ВСЁ РАБОТАЕТ: чаты, имя, темы, поиск, игры, счётчик, ГДЗ, GigaChat
# ============================================
...
# === ВЫБОР МОДЕЛИ ===
current_ai_model = "myxa"   # "myxa" или "gigachat"
...
GIGACHAT_TOKEN = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJnaWdhY2hhdF9wdWJsaWMifQ..."

def ask_gigachat(prompt):
    """Нейросеть GigaChat от Сбера"""
    if GIGACHAT_TOKEN == "ТВОЙ_ТОКЕН_ОТ_СБЕРА":
        return "❌ Токен GigaChat не указан. Вставь свой токен в переменную GIGACHAT_TOKEN."
...
def open_help():
    ...
    help_text = (
        ...
        "📚 ШКОЛА: таблица 5\n\n"
        "🤖 GigaChat: кнопка «GigaChat» — нейросеть Сбера"
    )
...
def switch_to_gigachat():
    global current_ai_model
    current_ai_model = "gigachat"
    add_message("MYXA AI", "🤖 Режим GigaChat активирован. Все сообщения будут обрабатываться нейросетью Сбера.")
...
make_button("🤖 GigaChat", switch_to_gigachat)
