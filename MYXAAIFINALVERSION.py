...
# ВСЁ РАБОТАЕТ: чаты, имя, темы, поиск, игры, счётчик, ГДЗ, МОДЕЛИ, МЫШЛЕНИЕ, МОНЕТКА
# ============================================
...
def process_ai(text):
    ...
    if current_ai_model != "myxa":
      try:
            ...
            return "⏰ DeepSeek думает слишком долго. Попробуй Phi-3 или позже."
