...
# ============================================
# ----------- БЕСПЛАТНАЯ НЕЙРОСЕТЬ (URLLIB) ---
# ============================================

def ask_free_ai(prompt):
    """Бесплатная русская нейросеть Saiga (через urllib, без requests)"""
    try:
        url = "https://api-inference.huggingface.co/models/IlyaGusev/saiga_llama3_8b"
        data = json.dumps({"inputs": prompt, "parameters": {"max_new_tokens": 200}}).encode('utf-8')
